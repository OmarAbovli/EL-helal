    ...
    <main>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <h2 className="mt-10 text-xl font-semibold">الباقات التعليمية</h2>
          <div className="mt-4 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {packages.length === 0 && <p className="text-sm text-muted-foreground">لا توجد باقات متاحة حالياً.</p>}
          </div>
          ...
          <div className="mt-4 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {photos.length === 0 && <p className="text-sm text-muted-foreground">لا توجد صور متاحة حالياً.</p>}
          </div>
        </div>
      </section>
    </main>
