...
export const metadata: Metadata = {
  title: "Competooo | لغة إنجليزية للثانوية العامة مع الأستاذ تامر هلال",
  description: "Competooo منصة تعليمية لتعلم اللغة الإنجليزية لطلاب الصف الأول والثاني والثالث الثانوي في طنطا. اكتشف دروسًا تفاعلية، دورات فيديو شاملة، واختبارات ديناميكية. مع الأستاذ تامر هلال، اجعل تعلم الإنجليزية ممتعًا وفعالًا.",
  keywords: ["Competooo", "لغة إنجليزية", "ثانوية عامة", "الأستاذ تامر هلال", "طنطا", "دروس إنجليزية", "شروحات فيديو", "اختبارات إنجليزية", "تعليم أونلاين", "الصف الأول الثانوي", "الصف الثاني الثانوي", "الصف الثالث الثانوي", "تعلم الإنجليزية"],
  openGraph: {
    title: "Competooo | لغة إنجليزية للثانوية العامة مع الأستاذ تامر هلال",
    description: "Competooo منصة تعليمية لتعلم اللغة الإنجليزية لطلاب الصف الأول والثاني والثالث الثانوي في طنطا. اكتشف دروسًا تفاعلية، دورات فيديو شاملة، واختبارات ديناميكية. مع الأستاذ تامر هلال، اجعل تعلم الإنجليزية ممتعًا وفعالًا.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Competooo منصة تعليمية للغة الإنجليزية",
      },
    ],
  },
  twitter: {
